...
* fix: added bump of package-lock.json to gulp release task ([b0f318d](https://github.com/bigcommerce/stencil-cli/commit/b0f318d))
* fix: added npm install to gulp task ([1d59dfc](https://github.com/bigcommerce/stencil-cli/commit/1d59dfc))
